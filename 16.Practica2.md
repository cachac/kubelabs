...
Las imágenes de estos servicios fueron construidas y ahora tienen un requerimiento de infraestructura que provea un sistema de escalamiento automático y contenerización.
...
## 1.1. Todos los objetos Kubernetes deben ser creados en archivos YAML, con el objetivo de recrear la solución de forma automatizada
## 1.2. Namespaces
...
## 2.4. Es un página SPA, por lo que solo necesita una ruta apuntando a su root (/)
...
### 2.7.2. Editar el archivo agregando el dominio de cada laboradorio
> Editar únicamente el nombre SUBDOMINIO USUARIO (XXXXX)
