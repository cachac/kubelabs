...
## 4.6. Este servicio se accede por la ruta websocket.<USERLAB>.kubelabs.<TLD> (.online ó .dev)
...
## 5.3. Replicas: 2
## 5.4. Puerto 3000
## 5.5. Este servicio se accede por la ruta api.<USERLAB>.kubelabs.<TLD> (.online ó .dev) 
