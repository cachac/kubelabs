...
- Los archivos deben mantenerse posterior a la eliminación del volumen
- Escritura y lectura desde un único punto (RWO)
- Almacenamiento 50Mi
...
### 10.2.2. El API público es un servicio de alta demanda que debe crecer automaticamente cuando:
