...
## 3.7. En este punto la página ya debería se accedida mediante el browser.

## 3.8. La página requiere montar un archivo de configuración con las siguientes características:
### 3.8.1. Ubique del archivo en la máquina virtual:
...
Utiliza el siguiente valor como password para conectar con la página

> TOKEN_SECRET: PASS

## 4.6. Este servicio se accede por la ruta websocket.<USERLAB>.kubelabs.<TLD>
## 4.7. La ruta es /graphql
...
## 5.3. Replicas: 2
## 5.4. Puerto 3000
## 5.5. Este servicio se accede por la ruta api.<USERLAB>.kubelabs.<TLD>
## 5.6. La ruta es /graphql
