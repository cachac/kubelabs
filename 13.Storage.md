...
```
## 4.4. Validar el enpoint del service
...
# 6. Probar en Browser en puerto 30080
...
> Cual es la razón por la cual la página no carga?

- Los pods están corriendo?
- El PV y PVC están conectados?
- El pod se expuso por un puerto correcto?
