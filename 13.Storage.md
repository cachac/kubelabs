...
## 4.1. Crear el archivo static-pvc.yaml
...
# 5. Crear un Pod que utilice el PVC
> [assets/static-pod-pvc.yaml](./assets/static-pod-pvc.yaml)

## 5.1. Crear el Archivo: static-pod-pvc.yaml
```yaml
apiVersion: apps/v1
kind: Deployment
...
# 9. Ejecutar un Pod que consuma el auto-pvckube-labskube-labs
