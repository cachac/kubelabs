...
>
> La recomandación es utilizar un almacenamiento externo al Worker Node!

## 1. Parte 1: Crear un nuevo Pod utilizando un archivo local
...
### 1.4. Opcional, cambiar el contenido del archivo html
...
## 2. Agregar un volumen persistente tipo HostPath
...
### 2.1. Ejecutar el archivo static-pv.yml
...
### 2.2. Desplegar el volumen persistente
```vim
kubectl get pv
```
...
### 2.3. Reclamar el espacio con un PVC.
...
### 2.5. Crear un Pod que utilice el PVC
...
### 2.7. Opcional: probar el almacenamiento local /logs
```vim
...
### 3.1. Crear el storage class utilizando el archivo storage-class-gce.yml
...
### 3.2. Resolver el problema del PVC y ejecutar de nuevo
...
### 3.3. Ejecutar un Pod que consuma el auto-pvc
